...
```{r}
StartingMedianSalariesPlot <- party::ctree(Above_Avg_Starting_Median_Salary ~ Region + School_Type, data = StartingAvgMedianSalary)
plot(StartingMedianSalariesPlot, type = "simple")
```
