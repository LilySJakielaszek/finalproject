...
```{r}
MidCareerMedianSalaries %>%
  ggplot(aes(x = School_Name, y = Mid_Career_Median_Salary, color = Region)) +
  facet_wrap(~ School_Type) +
  geom_point(size = 1) +
  xlab("School Name") +
  ylab("Top Mid-Career Median Salaries") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
In conclusion, a student should choose the college , the major , and the occupation . 
