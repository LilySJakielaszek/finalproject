...
```{r}
salaries_by_region %>%
  mutate(Mid-Career_Median_Salary = as.numeric(`Mid-Career Median Salary`),
        Starting_Median_Salary = as.numeric(`Starting Median Salary`)) %>%
  group_by(Region) %>%
  summarise(difference = "Mid-Career Median Salary" - "Starting Median Salary") 
